...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-3w-8-Ik1.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bhx0Y2SY.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "My_Portfolio";
var SERVER_FN_BASE = "/My_Portfolio/_serverFn/";
